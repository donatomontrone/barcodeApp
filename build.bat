@echo off
REM === CONFIGURAZIONE ===
set JFX_SDK=C:\Users\DonatoMontrone\Downloads\javafx-sdk-17.0.15
...
jpackage ^
  ...
  --type exe ^
  --icon %ICON% ^
  --java-options "-Xmx512m -Dprism.order=sw" ^
